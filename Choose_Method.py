...
def choose_method(method_name,alpha1,alpha2,folder,pi, real_cmdp, sim_iterations, real_iterations,
    ...
    if method_name=="CPG":
        ...
        uncertainty_set=DummyUncertaintySet(states=real_cmdp.states,actions=actions)
        ...
        uncertainty_set = HoeffdingSet(delta=0.999, states=real_cmdp.states, actions=actions, D_S=D_S, D_A=D_A,
